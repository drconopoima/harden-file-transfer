...
public class ChangePasswordApiController implements ChangePasswordApi {
    ...
    public ResponseEntity<Boolean> changePassword(
            @Parameter(in = ParameterIn.DEFAULT, description = "", required = true, schema = @Schema()) @RequestParam(value = "oldPassword", required = true) String oldPassword,
            @Parameter(in = ParameterIn.DEFAULT, description = "", required = true, schema = @Schema()) @RequestParam(value = "newPassword", required = true) String newPassword) {
